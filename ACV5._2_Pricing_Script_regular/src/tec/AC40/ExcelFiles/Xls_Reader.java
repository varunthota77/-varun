...
public class Xls_Reader {
	...
	public static void main(String arg[]) throws IOException {
		...
		datatable = new Xls_Reader(System.getProperty("user.dir")
				+ "\\src\\tec.ypd.config\\TestData.xlsx");
		for (int col = 0; col < datatable.getColumnCount("TC5"); col++) {
			System.out.println(datatable.getCellData("TC5", col, 1));
		}
	}

		public String getSheetData(String sheetName, int rowNum, int cellNum)
			throws EncryptedDocumentException, InvalidFormatException,
			IOException
	{	
		String filepath = "D:\\ACV5._2_Pricing_Script\\TestData\\TestData.xlsx";
		//String filepath1 ="D:\\pricing\\ACV5._2_Pricing_Script\\TestData\\TestData.xlsx";
		FileInputStream fiso = new FileInputStream(filepath);
		Workbook wk = WorkbookFactory.create(fiso);
		org.apache.poi.ss.usermodel.Sheet sh=wk.getSheet(sheetName);
